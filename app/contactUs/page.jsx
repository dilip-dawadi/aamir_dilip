	...
	return (
		<>
			...
			<h2 className="text-5xl underline underline-offset-8 ">For Business Enquiries </h2>
				...
				<p className="inline-flex text-3xl px-3 text-white"><svg class="w-6 h-6 text-gray-900" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="black" viewBox="0 0 24 24">
				...
				<p className=" inline-flex text-white text-3xl"><svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="black" viewBox="0 0 24 24">
